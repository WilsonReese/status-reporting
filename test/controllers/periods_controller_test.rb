...
class PeriodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create period" do
    assert_difference('Period.count') do
      post periods_url, params: { period: { end: @period.end, reports_count: @period.reports_count, start: @period.start } }
    end
  ...
  test "should update period" do
    patch period_url(@period), params: { period: { end: @period.end, reports_count: @period.reports_count, start: @period.start } }
